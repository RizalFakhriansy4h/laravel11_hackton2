		...
		<div class="row">
			<div class="col text-center">
				<div class="event-info">
					<h2>{{ $event->title }}</h2>
					<p>{{ $event->start_datetime }} at {{ $event->location }}</p>
				</div>
				<div id="timer" class="timer-container"></div>
				<button class="btn btn-warning btn-lg" disabled>Tickets Sold Out</button>
...
<div class="col-12 col-sm-8 col-lg-7 text-center">
...
<div class="container mt-5">
	<div class="card mb-3" style="max-width: 720px;">
		<div class="row g-0">
			<div class="col-md-4">
				<img src="https://i.pinimg.com/474x/bf/a2/0e/bfa20e3b1e7448bf778e5a01600226b1.jpg" class="img-fluid rounded-start" alt="...">
			</div>
			<div class="col-md-8 d-flex flex-column justify-content-start">
				<!-- Button Section -->
				<div class="mb-2 d-flex justify-content-between flex-wrap button-section" style="padding: 10px;">
					<a class="btn btn-outline btn-smaller" href="#" role="button">Introduction</a>
					<button class="btn btn-outline btn-smaller" type="">What we offer</button>
					<button class="btn btn-outline btn-smaller" type="">What is metter</button>
					<button class="btn btn-outline btn-smaller" type="">Join Us</button>
				</div>
				<!-- Card Body -->
				<div class="card-body">
...
<div class="container">
	<div class="row justify-content-center">
		<div class="col-12 col-sm-8 col-lg-7 text-center">
			...
			<h3>(Post Conference Highlight)</h3>
		</div>
	</div>
	<!--yt-->
	<div class="container">
		<div class="row justify-content-center align-items-center" style="height: 100vh;">
			<div class="col-12 col-lg-10 text-center">
				<iframe src="{{ $event->url_youtube }}" style="width: 80vw; height: 45vw;" allowfullscreen title="YouTube Video"></iframe>
			</div>
		</div>
	</div>
	<!--google maps-->
			...
			<div class="mapouter">
				<div class="gmap_canvas">
					<iframe class="map-iframe" id="gmap_canvas" 
						...
						title="Google Maps - Our Location"></iframe>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="contact-form-panel">
					...
					<div class="contact-form-inputs wow fadeInUp" data-wow-delay=".6s">
						<div class="custom-form-area input-boxed">
							...
							<form class="main-form" id="contact-us-form" action="{{ route('sendMail') }}" method="post">
								@csrf
								...
								<div class="row ">
									...
									<div class="col-12 submit-wrapper">
										<button class="btn-solid" type="submit">Send your message</button>
									</div>
								</div>
							</form>
						</div>
	...
	function startTimer(duration, display) {
	    ...
	    const interval = setInterval(function () {
	        ...
	        if (--timer < 0) {
	            ...
	            display.textContent = "Event is happening now!";
	        }
	    }, 1000);
	}
	
	window.onload = function () {
		const eventDate = new Date("{{ date('F j, Y H:i:s', strtotime($event->start_datetime)) }}");
	    const now = new Date();
	    const countdownDuration = Math.floor((eventDate - now) / 1000);
