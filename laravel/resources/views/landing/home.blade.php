...
<section class="page-hero  d-flex align-items-center   pb-0" id="page-hero">
	<div class="overlay-photo-image-bg" data-bg-img="/assets2/assets/images/sections-bg-images/pattern-bg-2.jpg" data-bg-opacity=".2"></div>
	...
	<div class="container">
					...
					<div class="row">
						...
						<div class="col-12   ">
							<div class="play-btn-row-dir ">
								<a class="video-link" href="https://www.youtube.com/watch?v=Kgrumz_76RI&t=6s" role="button" title="play" data-fancybox="data-fancybox">
		...
		<div class="col-12   mx-md-auto  text-center " data-tilt>
			<div class="hero-image-area ">
				<div class="hero-img-wraper  "><img class="img-fluid " src="/assets2/assets/hero/illustration-2.png" alt="" draggable="false"></div>
			</div>
		</div>
		<!--End of .image-area -->
	</div>
...
<div class="container">
	<div class="row">
		<div class="col">
			<div class="card">
				<img src="https://i.pinimg.com/564x/c9/60/61/c960619cc3a1544a1168a2b7f4677141.jpg" class="card-img-top" alt="...">
				<div class="card-body">
					<h5 class="card-title">Consultation and Mentoring</h5>
				</div>
			</div>
		</div>
		<div class="col">
			<div class="card">
				<img src="https://i.pinimg.com/474x/61/81/9a/61819a47c2986a865d6c976b7be1702e.jpg" class="card-img-top" alt="...">
				<div class="card-body">
					<h5 class="card-title">Network and Connection</h5>
				</div>
			</div>
		</div>
		<div class="col">
			<div class="card">
				<img src="https://i.pinimg.com/474x/44/c1/6a/44c16abf87f77dd95651d1346fada695.jpg" class="card-img-top" alt="...">
				<div class="card-body">
					<h5 class="card-title">Research and Publication</h5>
				</div>
			</div>
		</div>
		<div class="col">
			<div class="card">
				<img src="https://i.pinimg.com/564x/13/e7/cc/13e7cc38e72154f75248137424e50163.jpg" class="card-img-top" alt="...">
				<div class="card-body">
					<h5 class="card-title">Advocacy and Policy</h5>
				</div>
			</div>
		</div>
		<div class="col">
			<div class="card">
				<img src="https://i.pinimg.com/474x/5e/f1/8d/5ef18da7754daa562e0562f824c099d2.jpg" class="card-img-top" alt="...">
				<div class="card-body">
...
<section class="testimonials testimonials-1-col   has-dark-bg  mega-section " id="testimonials-img-bg">
	<div class="overlay-photo-image-bg parallax " data-bg-img="/assets2/assets/hero/hero.jpg" data-bg-opacity=".25"> </div>
	<div class="container">
		<div class="sec-heading  centered ">
			<div class="content-area">
				<span class=" pre-title       wow fadeInUp " data-wow-delay=".2s"></span>
				<h2 class=" title    wow fadeInUp" data-wow-delay=".4s">Last <span class='hollow-text'>Event</span></h2>
			</div>
		</div>
						...
						<div class="swiper-slide">
							<div class="testmonial-card d-flex align-items-center justify-content-center">
								<div class="testimonial-content">
									<div class="customer-img "><img class="img-fluid " loading="lazy" src="{{ $event->thumbnail }}" alt="{{ $event->title }}"></div>
									<div class="customer-testimonial">
										<div class="content">
											<h3><a href=""><a href="{{ route('detailEvent',['title' => $event->slug]) }}">{{ $event->title }}</a></a></h3>
											<p class="testimonial-text ">{{ $event->description }}</p>
										</div>
									</div>
								</div>
							</div>
...
<!-- End  testimonials-->
<!--sec heading-->
<div class="sec-heading mt-5" id="upcoming-event">
	<h2 class="title wow fadeInUp" data-wow-delay=".4s">Upcoming <span class='hollow-text'>event</span></h2>
</div>
<!--cards 3-->
<div class="custom-margin"></div>
	...
	<div class="row g-0">
		<div class="col-md-4">
			<div class="card bg-dark text-white">
				<img src="https://i.pinimg.com/564x/b1/b7/dc/b1b7dc935b08a6aaa0712836ce0facd8.jpg" class="card-img" alt="...">
		...
		<div class="col-md-4">
			<div class="card bg-dark text-white">
				<img src="https://i.pinimg.com/474x/a4/6d/a1/a46da1aad86616871415a7232e5d69b9.jpg" class="card-img" alt="...">
				<div class="card-img-overlay">
				</div>
			</div>
		</div>
		<div class="col-md-4">
			<div class="card bg-dark text-white">
				<img src="https://i.pinimg.com/474x/ce/3d/c2/ce3dc2e31e3d55c7a2c8f0f0fedf0a70.jpg" class="card-img" alt="...">
				<div class="card-img-overlay">
				</div>
			</div>
		</div>
...
<section class="our-clients  mega-section   wow fadeInUp" id="our-clients" data-wow-delay="0.2s">
	<div class="container">
		<div class="sec-heading   centered ">
			<div class="content-area">
				<h2 class=" title    wow fadeInUp" data-wow-delay=".4s">Collaboration With Partners</h2>
			</div>
		</div>
		<div class=" clients-logos ">
			...
			<div class="swiper-container">
				<div class="swiper-wrapper clients-logo-wrapper wow fadeIn " data-wow-delay=".02s">
					@foreach($sposnsors as $sposnsor)
					<div class="swiper-slide">
						<div class="client-logo"><a><img class="img-fluid logo" loading="lazy" src="{{ $sposnsor->image }}" alt="{{ $sposnsor->name }}"></a></div>
					</div>
					@endforeach
				</div>
			</div>
